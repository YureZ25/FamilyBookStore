...
namespace Services.Services
{
    internal class ImageService : IImageService
    {
        ...
        {
            var textHtml = $"""
                <span style="text-align: center;" xmlns="http://www.w3.org/1999/xhtml">
                    <h5>{bookVM.Title}</h5>
                    <p style="font-style: italic;">{bookVM.Author}</p>
                </span>
                """;

            return $"""
                <svg class="{cssClasses}" height="100%" width="80%" xmlns="http://www.w3.org/2000/svg" role="img">
